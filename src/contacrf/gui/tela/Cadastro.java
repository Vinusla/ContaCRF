...
public class Cadastro implements EventHandler<ActionEvent>{
	public void handle(ActionEvent evento) {
		...
		conta.setNumero(String.valueOf(random.nextInt(88000)+1000) +"-"+ random.nextInt(10));
		hb8.getChildren().addAll(new Label("Password"),bot.getPassword(),new Label("Numero "+ conta.getNumero()),new Label("Agencia "+agencia.getNumero()));
		cena.add(hb1, 0, 0);
		cena.add(hb2, 0, 1);
		cena.add(hb3, 0, 2);
		cena.add(hb4, 0, 3);
